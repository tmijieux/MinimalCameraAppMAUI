...
namespace MinimalCameraApp.Platform.Renderers.Camera
{
    public class CameraTextureView : TextureView
    {
        ...
        public CameraTextureView(Context context, IAttributeSet attrs) : base(context, attrs, 0)
        {
        }

        public CameraTextureView(Context context, IAttributeSet attrs, int defStyle) : base(context, attrs, defStyle)
        {
        }
